...
- Current non-production branch candidate: Reviewer Workflow Roving Keyboard & Accessibility Snapshot Gate v1 adds arrow-key roving focus and semantic snapshot coverage for the reviewer workflow without production, schema, persistence, external-call, analytics, or keyboard-triggered review mutation scope.
