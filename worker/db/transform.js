...
export function rowToLead(row) {
  ...
  return {
    ...
    painPoint: row.pain_summary || '',
    businessImpact: row.business_impact || '',
    likelyInitiative: row.likely_initiative || '',
    stakeholderHint: row.stakeholder_hint || '',
    ...
    missingInformation: (() => { try { return JSON.parse(row.missing_information || '[]'); } catch { return []; } })(),
...
export function leadToRow(lead, profileId, source) {
  ...
  return {
    ...
    pain_summary: lead.painPoint || '',
    business_impact: lead.businessImpact || '',
    likely_initiative: lead.likelyInitiative || '',
    stakeholder_hint: lead.stakeholderHint || '',
    signal_strength: Number(lead.signalStrength) || 0,
    ...
    missing_information: JSON.stringify(Array.isArray(lead.missingInformation) ? lead.missingInformation : []),
