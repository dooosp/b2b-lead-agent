...
| --- | --- | --- | --- |
| Shipped | Review gate | Current LeadBrief baseline plus Workbench | Summarize readiness and blockers from existing review, verification, confidence, evidence, source, and data-gap fields without approving outreach. |
